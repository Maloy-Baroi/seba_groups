              ...
              <ul className={sidebarStyle.mainUl}>
                  ...
                  <li className={"submenu-open "}>
                      ...
                      <ul className={sidebarStyle.sidebarNavUl}>
                          ...
                          <li className={props.activeState === "Shelf" ? sidebarStyle.active : ""}>
                              <Link href={"/seller/"}>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          ...
                          <li className={props.activeState === "sub_category" ? sidebarStyle.active : ""}>
                              <Link href={"/seller/"}>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                       viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                                       strokeLinecap="round" strokeLinejoin="round"
                                  ...
                                  <span>Sub Category</span></Link></li>
                          <li className={props.activeState === "import_products" ? sidebarStyle.active : ""}>
                              <Link href={"/seller/"}>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                       viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                                       strokeLinecap="round" strokeLinejoin="round"
